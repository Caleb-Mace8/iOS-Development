...
if let unwrappedCheckAge = checkAge("12s"){
    print(unwrappedCheckAge)
}
...
func inStock(itemName: String) -> Double? {
...
if let unwrapped = inStock(itemName: "Banana") {
    print(unwrapped)
}
/*:
