...
func mealChecker(_ mealType: String) -> Meal? {
    switch mealType {
    case "Breakfast":
...
if let unwrapped = mealChecker("Breakfast") {
    print(unwrapped)
}
//print(mealChecker("Dinner")) prints nil
//print(mealChecker("1")) prints nil
/*:
 ...
 */
func dataCheck() -> [String: Any]? {
    if let checkedData = UserDefaults.standard.dictionary(forKey: "mealLog") {
        return checkedData
    } else {
        return nil
    }
